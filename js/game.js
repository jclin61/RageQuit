 $(document).ready(function(){
 	$('#accepted').click(function(){
 		...
 		function GameStart()
 		{
 			...
 			setTimeout(function(){
 				$("#damsel").attr('src','test_image/damsel1.png');
 			},5200);
 			setTimeout(function(){
 				$("#damsel").attr('src','test_image/damsel2.png');
 			},5400);
 			...
 			Derpina = setTimeout(function(){
 				$("#damsel").attr('src','test_image/damsel3.png');
 				$("textarea").append('&#xA;'+'==> Derpina is worried!' + '&#xA;');
 			},10000);
 		...
 		function collision()
 		{
 			$(document).keydown(function(){
	 			...
	 			if(hit == 3)
	 			{
	 				...
	 				$("#damsel").attr('src','test_image/damsel1.png');
	 				$("#rider").attr('src','test_image/rider9.png').css({
	 					height: '150px',
	 					top: '300px',
	 					left:'20px'});
	 				$("#win").css({
	 				...
	 				$("#restart").css({
	 					visibility: 'visible'});
	 				$("#troll").attr('src','test_image/troll5.png').css({
	 					height: '100px',
	 					visibility: 'visible'
	 				});
				...
				if(troll_pos.top<60 && troll_pos.left <60)
	 			{
	 				...
	 				clearInterval(random_level);
	 				clearTimeout(GameDelay);
	 				$("#damsel").attr('src','test_image/damsel4.png');
	 				$("#rider").attr('src','test_image/rider8.png').css({
	 					height: '150px',
	 					top: '290px',
	 					left:'300px'});
	 				$("#gg").css({
	 					visibility: 'visible'});
	 				$("#troll").attr('src','test_image/troll4.jpeg').css({
	 					height: '150px',
	 					visibility: 'visible'
	 				});
 		...
 		function level3()  //Movement becomes completely unpredictable.
 		{
	 			...
	 			$("#troll").attr('src','test_image/troll3.png').css({
		 					height: '60px'});
		        $(document).keydown(function(data){
		          var x = parseInt($("#rider").css('left'));
		          var y = parseInt($("#rider").css('top'));
